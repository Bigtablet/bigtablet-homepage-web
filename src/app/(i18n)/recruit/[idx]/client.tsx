				...
				<>
					...
					<section className={styles.recruit_detail_section}>
						...
						<p className={styles.recruit_detail_notice_text}>
							경우에 따라 간단한 사전 과제 또는 레퍼런스 체크가 진행될 수
							있습니다.
						</p>
					</section>
					...
					<section className={styles.recruit_detail_notice}>
						...
						<p className={styles.recruit_detail_notice_text}>
							다음의 경우에 해당될 시, 채용 절차가 중단되거나 입사가 중단될 수
							있습니다:
						</p>
						<ul className={styles.recruit_detail_notice_list}>
							<li>
								지원자가 채용과 관련하여 부당한 청탁이나 부적절한 요청을 한 경우
							</li>
							<li>지원자가 국내 취업 또는 해외 여행에 결격 사유가 있는 경우</li>
							<li>
								회사 규정상 직무 수행에 지장을 줄 수 있는 징계 이력, 법 위반
								사항 또는 기타 결격 사유가 발견된 경우
							</li>
							<li>
								지원 과정에서 제출된 정보가 허위거나 증빙 불가하거나 고의 누락된
								사실이 발견된 경우
							</li>
