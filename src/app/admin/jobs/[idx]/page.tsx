...
const JobsDetail = ({ params }: { params: { idx: string } }) => {
    const idx = Number(params.idx);
    if (!Number.isFinite(idx)) notFound();

    const { data, isLoading, isError } = useRecruitApplicantDetailQuery(idx);
                    ...
                    <>
                        <section className="card applicant-detail__profile">
                            <img
                                ...
                                alt={data.name}
                                className="applicant-detail__thumb"
                            />
                            <div className="profile__info">
                                ...
                                <div className="row">
                                    ...
                                    <div className={`value status status--${String(data.status).toLowerCase()}`}>
                        ...
                        <section className="card">
                            ...
                            <div className="grid">
                                <div className="row">
                                    ...
                                    <div className="value">{educationLabel(data.educationLevel)}</div>
                                </div>
                                <div className="row">
                                    <div className="label">학교</div>
                                    <div className="value">{data.schoolName ?? "-"}</div>
                                </div>
                                <div className="row">
                                    <div className="label">전공</div>
                                    <div className="value">{departmentLabel(data.department) || "-"}</div>
                                </div>
                                <div className="row">
                                    <div className="label">입학</div>
                                    <div className="value">{data.admissionYear ?? "-"}</div>
                                </div>
                                <div className="row">
                                    <div className="label">졸업</div>
                                    <div className="value">{data.graduationYear ?? "-"}</div>
                                </div>
                                <div className="row">
                                    <div className="label">병역</div>
                                    <div className="value">{militaryLabel(data.military)}</div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="card">
                            ...
                            <div className="grid">
                                ...
                                <div className="row">
                                    ...
                                    <div className="value">{data.addressDetail}</div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="card">
                            ...
                            <div className="grid">
                                <div className="row">
                                    ...
                                    <div className="value">
                                        <a href={data.portfolio} target="_blank" rel="noreferrer" className="link">
                                            {data.portfolio}
                                        </a>
                                    </div>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="value">
                                        {data.attachment1 ? (
                                            <a className="link" href={data.attachment1} target="_blank" rel="noreferrer">
                                                {data.attachment1}
                                            </a>
                                        ) : (
                                            "-"
                                ...
                                <div className="row">
                                    ...
                                    <div className="value">
                                        {data.attachment2 ? (
                                            <a className="link" href={data.attachment2} target="_blank" rel="noreferrer">
                                                {data.attachment2}
                                            </a>
                                        ) : (
                                            "-"
                                ...
                                <div className="row">
                                    ...
                                    <div className="value">
                                        {data.attachment3 ? (
                                            <a className="link" href={data.attachment3} target="_blank" rel="noreferrer">
                                                {data.attachment3}
                                            </a>
                                        ) : (
                                            "-"
