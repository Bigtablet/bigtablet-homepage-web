        ...
        <footer className="footer">
            <div className="footer__inner">
                ...
                <ul className="footer__social" aria-label="social links">
                    <li>
                        <a href="https://www.linkedin.com" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="footer__social-btn">
                    ...
                    <li>
                        <a href="https://x.com" target="_blank" rel="noreferrer" aria-label="X" className="footer__social-btn">
                            <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
